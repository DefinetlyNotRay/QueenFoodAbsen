...
const HomePage: React.FC = () => {
  ...
  const fetchAttendanceData = async () => {
    try {
      ...
      const response = await axios.get(`https://0ca6-103-224-125-54.ngrok-free.app/attendance/${userId}`);
  ...
  const submitForm = async () => {
    ...
    try {
      ...
      const uploadResponse = await axios.post('https://0ca6-103-224-125-54.ngrok-free.app/upload-image', formData, {
      ...
      const saveResponse = await axios.post('https://0ca6-103-224-125-54.ngrok-free.app/save-data', {
        alasanInput,
        imageLink,
      });
